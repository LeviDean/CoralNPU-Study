vm.module public @module {
  ...
  ^bb17:  // pred: ^bb15
    ...
    vm.br ^bb18(%ref_26, %ref_24 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb18(%35: !vm.ref<!hal.fence>, %36: !vm.ref<!hal.buffer>):  // 2 preds: ^bb15, ^bb17
    vm.call.variadic.yieldable @hal.fence.await(%c-1_2, %zero_3, %35) {segment_sizes = dense<[-1, -1, 1]> : vector<3xi16>, segment_types = [i32, i64, !vm.ref<!hal.fence>]} : (i32, i64, !vm.ref<!hal.fence>) -> ^bb19 (i32)
  ^bb19(%37: i32):  // pred: ^bb18
    vm.cond_br %37, ^bb21, ^bb20
  ^bb20:  // pred: ^bb19
