func.func @main_dispatch_0_matmul_17x64x32_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert>} {
  ...
  scf.forall (%arg0) = (0) to (17) step (16) {
    ...
    %subview = memref.subview %4[%arg0, 0] [%5, 64] [1, 1] : memref<17x64xf32, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
    %6 = scf.for %arg1 = %c0 to %5 step %c16 iter_args(%arg2 = %subview) -> (memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) {
      ...
      %subview_8 = memref.subview %arg2[%arg1, 0] [%7, 64] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
      %8 = scf.for %arg3 = %c0 to %7 step %c8 iter_args(%arg4 = %subview_8) -> (memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) {
        %9 = affine.min affine_map<(d0)[s0] -> (-d0 + s0, 8)>(%arg3)[%7]
        %subview_10 = memref.subview %alloca_6[0, 0] [%9, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
        %cast = memref.cast %subview_10 : memref<?x8xf32, strided<[8, 1]>> to memref<?x8xf32>
        %10 = vector.create_mask %9, %c8 : vector<8x8xi1>
        vector.transfer_write %cst, %subview_10[%c0, %c0], %10 {in_bounds = [true, true]} : vector<8x8xf32>, memref<?x8xf32, strided<[8, 1]>>
        ...
        %14 = scf.for %arg5 = %c0 to %c64 step %c8 iter_args(%arg6 = %arg4) -> (memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) {
          %subview_11 = memref.subview %arg6[%arg3, %arg5] [%9, 8] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
          %subview_12 = memref.subview %cast[0, 0] [%9, 8] [1, 1] : memref<?x8xf32> to memref<?x8xf32, strided<[8, 1]>>
          %15 = vector.transfer_read %subview_12[%c0, %c0], %0, %10 {in_bounds = [true, true]} : memref<?x8xf32, strided<[8, 1]>>, vector<8x8xf32>
          %16 = scf.for %arg7 = %c0 to %c32 step %c1 iter_args(%arg8 = %15) -> (vector<8x8xf32>) {
            %subview_18 = memref.subview %1[%11, %arg7] [%9, 1] [1, 1] : memref<17x32xf32, #hal.descriptor_type<storage_buffer>> to memref<?x1xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
            %29 = vector.transfer_read %subview_18[%c0, %c0], %0, %12 {in_bounds = [true, true]} : memref<?x1xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8x1xf32>
            %30 = vector.transfer_read %2[%arg5, %arg7], %0 {in_bounds = [true, true]} : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8x1xf32>
          ...
          %subview_13 = memref.subview %alloca_5[0, 0] [%9, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
          ...
          vector.transfer_write %16, %subview_13[%c0, %c0], %10 {in_bounds = [true, true]} : vector<8x8xf32>, memref<?x8xf32, strided<[8, 1]>>
          %subview_14 = memref.subview %alloca[0, 0] [%9, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
          ...
          %subview_16 = memref.subview %cast_15[0, 0] [%9, 8] [1, 1] : memref<?x8xf32> to memref<?x8xf32, strided<[8, 1]>>
          ...
          %17 = vector.transfer_read %subview_14[%c0, %c0], %0, %10 {in_bounds = [true, true]} : memref<?x8xf32, strided<[8, 1]>>, vector<8x8xf32>
          %18 = vector.transfer_read %3[%arg5], %0 {in_bounds = [true]} : memref<64xf32, #hal.descriptor_type<storage_buffer>>, vector<8xf32>
          ...
          vector.transfer_write %28, %subview_11[%c0, %c0], %10 {in_bounds = [true, true]} : vector<8x8xf32>, memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
          %subview_17 = memref.subview %arg6[%arg3, %arg5] [%9, 8] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
      ...
      %subview_9 = memref.subview %arg2[%arg1, 0] [%7, 64] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
      linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%8 : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) outs(%subview_9 : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) {
      ^bb0(%in: f32, %out: f32):
        linalg.yield %in : f32
      }
      scf.yield %arg2 : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
    }
    %subview_7 = memref.subview %4[%arg0, 0] [%5, 64] [1, 1] : memref<17x64xf32, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
    linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%6 : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) outs(%subview_7 : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>) {
    ^bb0(%in: f32, %out: f32):
      linalg.yield %in : f32
    }
  } {mapping = [#iree_codegen.workgroup_mapping<x>]}
  linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%4 : memref<17x64xf32, #hal.descriptor_type<storage_buffer>>) outs(%4 : memref<17x64xf32, #hal.descriptor_type<storage_buffer>>) {
  ^bb0(%in: f32, %out: f32):
    linalg.yield %in : f32
  }
  return
