      ...
      scf.for %arg1 = %c0 to %7 step %c8 {
        ...
        scf.for %arg2 = %c0 to %c64 step %c8 {
          ...
          %13 = scf.for %arg3 = %c0 to %c32 step %c1 iter_args(%arg4 = %12) -> (vector<8x8xf32>) {
            ...
            %28 = vector.shape_cast %27 : vector<8xf32> to vector<8x1xf32>
            %29 = vector.transfer_read %assume_align_7[%arg2, %arg3], %0 {in_bounds = [true, true]} : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8x1xf32>
            %30 = vector.mask %11 { vector.contract {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %28, %29, %arg4 : vector<8x1xf32>, vector<8x1xf32> into vector<8x8xf32> } : vector<8x8x1xi1> -> vector<8x8xf32>
            scf.yield %30 : vector<8x8xf32>
          }
