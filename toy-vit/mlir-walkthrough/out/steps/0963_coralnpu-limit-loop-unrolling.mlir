func.func @main_dispatch_0_matmul_17x64x32_f32() {
  ...
  %8 = arith.minsi %7, %c16_11 : index
  %subview = memref.subview %assume_align_10[%5, 0] [%8, 64] [1, 1] : memref<17x64xf32, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
  %9 = arith.cmpi sgt, %8, %c0 : index
  scf.if %9 {
    %c-1_12 = arith.constant -1 : index
    %10 = arith.muli %5, %c-1_12 overflow<nsw> : index
    %c17_13 = arith.constant 17 : index
    %11 = arith.addi %10, %c17_13 : index
    %c16_14 = arith.constant 16 : index
    %12 = arith.minsi %11, %c16_14 : index
    %subview_15 = memref.subview %subview[0, 0] [%12, 64] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
    scf.for %arg0 = %c0 to %12 step %c8 {
      %c-1_16 = arith.constant -1 : index
      %13 = arith.muli %arg0, %c-1_16 overflow<nsw> : index
      %14 = arith.addi %13, %12 : index
      %c8_17 = arith.constant 8 : index
      %15 = arith.minsi %14, %c8_17 : index
      %subview_18 = memref.subview %alloca_7[0, 0] [%15, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
      %16 = vector.create_mask %15, %c8 : vector<8x8xi1>
      %17 = vector.extract %16[0] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c0, %c0], %17, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %18 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c1, %c0], %18, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %19 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c2, %c0], %19, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %20 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c3, %c0], %20, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %21 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c4, %c0], %21, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %22 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c5, %c0], %22, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %23 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c6, %c0], %23, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %24 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
      vector.maskedstore %subview_18[%c7, %c0], %24, %cst_0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
      %25 = arith.addi %arg0, %5 : index
      scf.for %arg1 = %c0 to %c64 step %c8 {
        %subview_19 = memref.subview %subview_15[%arg0, %arg1] [%15, 8] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
        %26 = vector.extract %16[0] : vector<8xi1> from vector<8x8xi1>
        %27 = vector.maskedload %subview_18[%c0, %c0], %26, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %28 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
        %29 = vector.maskedload %subview_18[%c1, %c0], %28, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %30 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
        %31 = vector.maskedload %subview_18[%c2, %c0], %30, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %32 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
        %33 = vector.maskedload %subview_18[%c3, %c0], %32, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %34 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
        %35 = vector.maskedload %subview_18[%c4, %c0], %34, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %36 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
        %37 = vector.maskedload %subview_18[%c5, %c0], %36, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %38 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
        %39 = vector.maskedload %subview_18[%c6, %c0], %38, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %40 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
        %41 = vector.maskedload %subview_18[%c7, %c0], %40, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        ...
        %51 = scf.for %arg2 = %c0 to %c32 step %c1 iter_args(%arg3 = %50) -> (vector<8x8xf32>) {
          %subview_22 = memref.subview %assume_align[%25, %arg2] [%15, 1] [1, 1] : memref<17x32xf32, #hal.descriptor_type<storage_buffer>> to memref<?x1xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
          %120 = arith.index_cast %15 : index to i32
          %121 = vector.broadcast %120 : i32 to vector<8xi32>
          %122 = arith.cmpi sgt, %121, %cst : vector<8xi32>
          %subview_23 = memref.subview %subview_22[0, 0] [%15, 1] [1, 1] : memref<?x1xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>> to memref<?xf32, affine_map<(d0)[s0] -> (d0 * 32 + s0)>, #hal.descriptor_type<storage_buffer>>
          %123 = scf.for %arg4 = %c0 to %c8 step %c1 iter_args(%arg5 = %0) -> (vector<8xf32>) {
            ...
            %207 = scf.if %206 -> (vector<8xf32>) {
              %208 = memref.load %subview_23[%arg4] : memref<?xf32, affine_map<(d0)[s0] -> (d0 * 32 + s0)>, #hal.descriptor_type<storage_buffer>>
          ...
          %124 = vector.load %assume_align_8[%arg1, %arg2] : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<1xf32>
          %c1_24 = arith.constant 1 : index
          %125 = arith.addi %arg1, %c1_24 : index
          ...
          %127 = arith.addi %arg1, %c2_25 : index
          ...
          %129 = arith.addi %arg1, %c3_26 : index
          ...
          %131 = arith.addi %arg1, %c4_27 : index
          ...
          %133 = arith.addi %arg1, %c5_28 : index
          %134 = vector.load %assume_align_8[%133, %arg2] : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<1xf32>
          %c6_29 = arith.constant 6 : index
          %135 = arith.addi %arg1, %c6_29 : index
          %136 = vector.load %assume_align_8[%135, %arg2] : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<1xf32>
          %c7_30 = arith.constant 7 : index
          %137 = arith.addi %arg1, %c7_30 : index
          %138 = vector.load %assume_align_8[%137, %arg2] : memref<64x32xf32, strided<[32, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<1xf32>
        ...
        %subview_20 = memref.subview %alloca_6[0, 0] [%15, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
        ...
        vector.maskedstore %subview_20[%c0, %c0], %53, %52 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %54 = vector.extract %51[1] : vector<8xf32> from vector<8x8xf32>
        %55 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c1, %c0], %55, %54 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %56 = vector.extract %51[2] : vector<8xf32> from vector<8x8xf32>
        %57 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c2, %c0], %57, %56 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %58 = vector.extract %51[3] : vector<8xf32> from vector<8x8xf32>
        %59 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c3, %c0], %59, %58 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %60 = vector.extract %51[4] : vector<8xf32> from vector<8x8xf32>
        %61 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c4, %c0], %61, %60 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %62 = vector.extract %51[5] : vector<8xf32> from vector<8x8xf32>
        %63 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c5, %c0], %63, %62 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %64 = vector.extract %51[6] : vector<8xf32> from vector<8x8xf32>
        %65 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c6, %c0], %65, %64 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %66 = vector.extract %51[7] : vector<8xf32> from vector<8x8xf32>
        %67 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_20[%c7, %c0], %67, %66 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32>
        %subview_21 = memref.subview %alloca[0, 0] [%15, 8] [1, 1] : memref<8x8xf32> to memref<?x8xf32, strided<[8, 1]>>
        ...
        %69 = vector.maskedload %subview_21[%c0, %c0], %68, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %70 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
        %71 = vector.maskedload %subview_21[%c1, %c0], %70, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %72 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
        %73 = vector.maskedload %subview_21[%c2, %c0], %72, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %74 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
        %75 = vector.maskedload %subview_21[%c3, %c0], %74, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %76 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
        %77 = vector.maskedload %subview_21[%c4, %c0], %76, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %78 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
        %79 = vector.maskedload %subview_21[%c5, %c0], %78, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %80 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
        %81 = vector.maskedload %subview_21[%c6, %c0], %80, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        %82 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
        %83 = vector.maskedload %subview_21[%c7, %c0], %82, %0 : memref<?x8xf32, strided<[8, 1]>>, vector<8xi1>, vector<8xf32> into vector<8xf32>
        ...
        %93 = vector.load %assume_align_9[%arg1] : memref<64xf32, #hal.descriptor_type<storage_buffer>>, vector<8xf32>
        ...
        vector.maskedstore %subview_19[%c0, %c0], %105, %104 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %106 = vector.extract %103[1] : vector<8xf32> from vector<8x8xf32>
        %107 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c1, %c0], %107, %106 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %108 = vector.extract %103[2] : vector<8xf32> from vector<8x8xf32>
        %109 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c2, %c0], %109, %108 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %110 = vector.extract %103[3] : vector<8xf32> from vector<8x8xf32>
        %111 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c3, %c0], %111, %110 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %112 = vector.extract %103[4] : vector<8xf32> from vector<8x8xf32>
        %113 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c4, %c0], %113, %112 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %114 = vector.extract %103[5] : vector<8xf32> from vector<8x8xf32>
        %115 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c5, %c0], %115, %114 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %116 = vector.extract %103[6] : vector<8xf32> from vector<8x8xf32>
        %117 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c6, %c0], %117, %116 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
        %118 = vector.extract %103[7] : vector<8xf32> from vector<8x8xf32>
        %119 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
        vector.maskedstore %subview_19[%c7, %c0], %119, %118 : memref<?x8xf32, strided<[64, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>, vector<8xi1>, vector<8xf32>
      } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
    } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  }
  return
