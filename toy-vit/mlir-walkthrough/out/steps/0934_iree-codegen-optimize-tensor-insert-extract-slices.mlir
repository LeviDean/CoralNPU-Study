  ...
  %9 = scf.forall (%arg0) = (0) to (17) step (16) shared_outs(%arg1 = %8) -> (tensor<17x64xf32>) {
    ...
    %11 = scf.for %arg2 = %c0 to %10 step %c16 iter_args(%arg3 = %extracted_slice) -> (tensor<?x64xf32>) {
      ...
      %13 = scf.for %arg4 = %c0 to %12 step %c8 iter_args(%arg5 = %extracted_slice_5) -> (tensor<?x64xf32>) {
        ...
        %20 = vector.create_mask %14, %c8 : vector<8x8xi1>
        %21 = vector.create_mask %14, %c8, %c1 : vector<8x8x1xi1>
        %22 = scf.for %arg6 = %c0 to %c64 step %c8 iter_args(%arg7 = %arg5) -> (tensor<?x64xf32>) {
          ...
          %23 = vector.transfer_read %extracted_slice_7[%c0, %c0], %0, %20 {in_bounds = [true, true]} : tensor<?x8xf32>, vector<8x8xf32>
          %24 = scf.for %arg8 = %c0 to %c32 step %c1 iter_args(%arg9 = %23) -> (vector<8x8xf32>) {
            ...
            %40 = vector.transfer_read %extracted_slice_10[%c0, %c0], %0, %19 {in_bounds = [true, true]} : tensor<?x1xf32>, vector<8x1xf32>
            %41 = vector.transfer_read %6[%arg6, %arg8], %0 {in_bounds = [true, true]} : tensor<64x32xf32>, vector<8x1xf32>
            %42 = vector.mask %21 { vector.contract {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d2)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d1)>], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %40, %41, %arg9 : vector<8x1xf32>, vector<8x1xf32> into vector<8x8xf32> } : vector<8x8x1xi1> -> vector<8x8xf32>
            scf.yield %42 : vector<8x8xf32>
          }
          %25 = vector.transfer_write %24, %extracted_slice_7[%c0, %c0], %20 {in_bounds = [true, true]} : vector<8x8xf32>, tensor<?x8xf32>
          %inserted_slice_8 = tensor.insert_slice %25 into %17[0, 0] [%14, 8] [1, 1] : tensor<?x8xf32> into tensor<?x8xf32>
          %dim = tensor.dim %inserted_slice_8, %c0 : tensor<?x8xf32>
          %26 = vector.create_mask %dim, %c8 : vector<8x8xi1>
          %27 = vector.transfer_read %inserted_slice_8[%c0, %c0], %0, %26 {in_bounds = [true, true]} : tensor<?x8xf32>, vector<8x8xf32>
          %28 = vector.transfer_read %7[%arg6], %0 {in_bounds = [true]} : tensor<64xf32>, vector<8xf32>
          %29 = vector.broadcast %28 : vector<8xf32> to vector<8x8xf32>
          %30 = arith.addf %27, %29 : vector<8x8xf32>
          %31 = math.powf %30, %cst_3 : vector<8x8xf32>
          %32 = arith.mulf %31, %cst_2 : vector<8x8xf32>
          %33 = arith.addf %30, %32 : vector<8x8xf32>
          %34 = arith.mulf %33, %cst_1 : vector<8x8xf32>
          %35 = math.tanh %34 : vector<8x8xf32>
          %36 = arith.addf %35, %cst_0 : vector<8x8xf32>
          %37 = arith.mulf %30, %cst : vector<8x8xf32>
          %38 = arith.mulf %37, %36 : vector<8x8xf32>
          %39 = vector.transfer_write %38, %extracted_slice_6[%c0, %c0], %26 {in_bounds = [true, true]} : vector<8x8xf32>, tensor<?x8xf32>
          %inserted_slice_9 = tensor.insert_slice %39 into %arg7[%arg4, %arg6] [%14, 8] [1, 1] : tensor<?x8xf32> into tensor<?x64xf32>
