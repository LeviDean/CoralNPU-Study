...
module attributes {stream.topology = #hal.device.topology<links = [(@__device_0 -> @__device_1 = {unified_memory = true, transparent_access = true}), (@__device_1 -> @__device_0 = {unified_memory = true, transparent_access = true})]>} {
  ...
  util.global private @__device_1_query_0_hal_executable_format_embedded_elf_riscv_32_ok : i1
  ...
  util.initializer {
    ...
    %__device_1_query_0_hal_executable_format_embedded_elf_riscv_32_ok = util.global.load @__device_1_query_0_hal_executable_format_embedded_elf_riscv_32_ok : i1
    ...
    %0 = arith.select %__device_1_query_0_hal_executable_format_embedded_elf_riscv_32, %c0, %c-1 : index
  ...
  ^bb1:  // pred: ^bb0
    ...
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%c-1_i64) type(%memory_type_0) usage(%buffer_usage_1) : !hal.buffer{%c8448}
