...
module attributes {stream.topology = #hal.device.topology<links = [(@__device_0 -> @__device_1 = {unified_memory = true, transparent_access = true}), (@__device_1 -> @__device_0 = {unified_memory = true, transparent_access = true})]>, vm.toplevel} {
  vm.module public @module {
    ...
    ^bb9:  // pred: ^bb8
      ...
      %_utf8_hal_device_id_C6650FF277232B5A_16 = vm.const.ref.rodata @_utf8_hal_device_id_C6650FF277232B5A : !vm.buffer
      %_utf8_coralnpu_87A7D9FDC197986D = vm.const.ref.rodata @_utf8_coralnpu_87A7D9FDC197986D : !vm.buffer
      %21:2 = vm.call @hal.device.query.i64(%ref_15, %_utf8_hal_device_id_C6650FF277232B5A_16, %_utf8_coralnpu_87A7D9FDC197986D) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
      %nz_17 = vm.cmp.nz.i64 %21#1 : i64
      %zero_18 = vm.const.i32.zero
      %22 = vm.select.i32 %21#0, %nz_17, %zero_18 : i32
      %c1_19 = vm.const.i32 1
      vm.cond_br %22, ^bb10, ^bb11(%zero_4 : i32)
    ^bb10:  // pred: ^bb9
      %_utf8_hal_executable_format_E03EECB63A2AAF52_20 = vm.const.ref.rodata @_utf8_hal_executable_format_E03EECB63A2AAF52 : !vm.buffer
      %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF = vm.const.ref.rodata @_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF : !vm.buffer
      %23:2 = vm.call @hal.device.query.i64(%ref_15, %_utf8_hal_executable_format_E03EECB63A2AAF52_20, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
      %nz_21 = vm.cmp.nz.i64 %23#1 : i64
      %zero_22 = vm.const.i32.zero
      %24 = vm.select.i32 %23#0, %nz_21, %zero_22 : i32
      %c1_23 = vm.const.i32 1
      vm.br ^bb11(%24 : i32)
    ^bb11(%25: i32):  // 2 preds: ^bb9, ^bb10
      %eq_24 = vm.cmp.eq.i64 %17, %zero_5 : i64
      %26 = vm.select.i64 %25, %c1, %zero_5 : i64
      %27 = vm.add.i64 %17, %26 : i64
      %28 = vm.and.i32 %25, %eq_24 : i32
      %ref_25 = vm.select.ref %28, %ref_15, %null_6 : !vm.ref<!hal.device>
      %29 = vm.add.i64 %16, %c1 : i64
      vm.br ^bb8(%29, %27, %ref_25 : i64, i64, !vm.ref<!hal.device>)
    ^bb12:  // pred: ^bb8
    ...
    ^bb14:  // 2 preds: ^bb12, ^bb13
      %_utf8_hal_executable_format_E03EECB63A2AAF52_26 = vm.const.ref.rodata @_utf8_hal_executable_format_E03EECB63A2AAF52 : !vm.buffer
      %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_27 = vm.const.ref.rodata @_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF : !vm.buffer
      %30:2 = vm.call @hal.device.query.i64(%18, %_utf8_hal_executable_format_E03EECB63A2AAF52_26, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_27) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
      %nz_28 = vm.cmp.nz.i64 %30#1 : i64
      %zero_29 = vm.const.i32.zero
      %31 = vm.select.i32 %30#0, %nz_28, %zero_29 : i32
      %c1_30 = vm.const.i32 1
      %32 = vm.select.i64 %31, %zero_5, %c-1_2 : i64
      %eq_31 = vm.cmp.eq.i64 %32, %zero_5 : i64
      vm.global.store.ref %18, @__device_1 : !vm.ref<!hal.device>
      vm.cond_br %eq_31, ^bb15, ^bb16
    ^bb15:  // pred: ^bb14
      %main_dispatch_0_embedded_elf_riscv_32 = vm.const.ref.rodata @main_dispatch_0_embedded_elf_riscv_32 : !vm.buffer
      %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_32 = vm.const.ref.rodata @_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF : !vm.buffer
      %null_33 = vm.const.ref.zero : !vm.buffer
      %ref_34 = vm.call @hal.executable.create(%18, %c-1_3, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_32, %main_dispatch_0_embedded_elf_riscv_32, %null_33) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
      vm.br ^bb17(%ref_34 : !vm.ref<!hal.executable>)
    ^bb16:  // pred: ^bb14
    ...
    ^bb17(%33: !vm.ref<!hal.executable>):  // 2 preds: ^bb15, ^bb16
      ...
      %ref_35 = vm.call @hal.device.allocator(%__device_1) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
      %c1_36 = vm.const.i32 1
      %ref_37 = vm.call @hal.allocator.import(%ref_35, %c1_36, %c-1_3, %c48, %c527363, %_const, %zero_5, %c8448) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
      %rnz = vm.cmp.nz.ref %ref_37 : !vm.ref<!hal.buffer>
      vm.global.store.ref %33, @__device_1_executable_0_main_dispatch_0 : !vm.ref<!hal.executable>
      vm.cond_br %rnz, ^bb19(%null, %ref_37 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb18
    ^bb18:  // pred: ^bb17
      %ref_38 = vm.call @hal.allocator.allocate(%ref_35, %c-1_3, %c48, %c527363, %c8448) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
      %c1_39 = vm.const.i32 1
      %ref_40 = vm.call @hal.ex.file.from_memory(%__device_1, %c-1_3, %c1_39, %_const, %zero_5, %c8448, %zero_0) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
      %zero_41 = vm.const.i64.zero
      %ref_42 = vm.call @hal.fence.create(%__device_1, %zero_41) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
      %zero_43 = vm.const.i64.zero
      vm.call @hal.device.queue.read(%__device_1, %c-1_3, %null, %ref_42, %ref_40, %zero, %ref_38, %zero_5, %c8448, %zero_43) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
      vm.br ^bb19(%ref_42, %ref_38 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
    ^bb19(%34: !vm.ref<!hal.fence>, %35: !vm.ref<!hal.buffer>):  // 2 preds: ^bb17, ^bb18
      %zero_44 = vm.const.i64.zero
      %36 = vm.call.variadic @hal.fence.await(%c-1, %zero_44, [%34]) : (i32, i64, !vm.ref<!hal.fence> ...) -> i32
      vm.cond_fail %36, "failed to wait on timepoint"
      vm.global.store.ref %35, @__hoisted_tensor_64xf32 : !vm.ref<!hal.buffer>
      %ref_45 = vm.call @__main_memoize_apply() : () -> !vm.ref<!hal.command_buffer>
      vm.global.store.ref %ref_45, @__main_memoize_result_0_device_1 : !vm.ref<!hal.command_buffer>
      vm.return
    }
