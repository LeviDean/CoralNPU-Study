vm.module public @module {
  ...
  vm.initializer {
    ...
    %null_5 = vm.const.ref.zero : !vm.ref<!hal.fence>
    %c48 = vm.const.i32 48
    ...
    vm.br ^bb1(%zero_4, %zero_4, %null_0 : i64, i64, !vm.ref<!hal.device>)
  ^bb1(%2: i64, %3: i64, %4: !vm.ref<!hal.device>):  // 2 preds: ^bb0, ^bb4
    %req = vm.cmp.eq.ref %4, %null_0 : !vm.ref<!hal.device>
  ...
  ^bb3:  // pred: ^bb2
    ...
    %10 = vm.select.i32 %9#0, %nz_6, %zero : i32
    vm.br ^bb4(%10 : i32)
  ^bb4(%11: i32):  // 2 preds: ^bb2, ^bb3
    %eq = vm.cmp.eq.i64 %3, %zero_4 : i64
    %12 = vm.select.i64 %11, %c1_1, %zero_4 : i64
    %13 = vm.add.i64 %3, %12 : i64
    %14 = vm.and.i32 %11, %eq : i32
    %ref_7 = vm.select.ref %14, %ref, %null_0 : !vm.ref<!hal.device>
    %15 = vm.add.i64 %2, %c1_1 : i64
  ...
  ^bb7:  // 2 preds: ^bb5, ^bb6
    ...
    vm.br ^bb8(%zero_4, %zero_4, %null_0 : i64, i64, !vm.ref<!hal.device>)
  ^bb8(%16: i64, %17: i64, %18: !vm.ref<!hal.device>):  // 2 preds: ^bb7, ^bb11
    %req_8 = vm.cmp.eq.ref %18, %null_0 : !vm.ref<!hal.device>
    %slt_9 = vm.cmp.lt.i64.s %16, %1 : i64
    %19 = vm.and.i32 %req_8, %slt_9 : i32
    vm.cond_br %19, ^bb9, ^bb12
  ^bb9:  // pred: ^bb8
    %20 = vm.trunc.i64.i32 %16 : i64 -> i32
    %ref_10 = vm.call @hal.devices.get(%20) {nosideeffects} : (i32) -> !vm.ref<!hal.device>
    %_utf8_hal_device_id_C6650FF277232B5A_11 = vm.const.ref.rodata @_utf8_hal_device_id_C6650FF277232B5A : !vm.buffer
    %_utf8_coralnpu_87A7D9FDC197986D = vm.const.ref.rodata @_utf8_coralnpu_87A7D9FDC197986D : !vm.buffer
    %21:2 = vm.call @hal.device.query.i64(%ref_10, %_utf8_hal_device_id_C6650FF277232B5A_11, %_utf8_coralnpu_87A7D9FDC197986D) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
    %nz_12 = vm.cmp.nz.i64 %21#1 : i64
    %22 = vm.select.i32 %21#0, %nz_12, %zero : i32
    vm.cond_br %22, ^bb10, ^bb11(%zero : i32)
  ^bb10:  // pred: ^bb9
    ...
    %23:2 = vm.call @hal.device.query.i64(%ref_10, %_utf8_hal_executable_format_E03EECB63A2AAF52_13, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
    %nz_14 = vm.cmp.nz.i64 %23#1 : i64
    %24 = vm.select.i32 %23#0, %nz_14, %zero : i32
    vm.br ^bb11(%24 : i32)
  ^bb11(%25: i32):  // 2 preds: ^bb9, ^bb10
    %eq_15 = vm.cmp.eq.i64 %17, %zero_4 : i64
    %26 = vm.select.i64 %25, %c1_1, %zero_4 : i64
    %27 = vm.add.i64 %17, %26 : i64
    %28 = vm.and.i32 %25, %eq_15 : i32
    %ref_16 = vm.select.ref %28, %ref_10, %null_0 : !vm.ref<!hal.device>
    %29 = vm.add.i64 %16, %c1_1 : i64
    vm.br ^bb8(%29, %27, %ref_16 : i64, i64, !vm.ref<!hal.device>)
  ^bb12:  // pred: ^bb8
    vm.cond_br %req_8, ^bb13, ^bb14
  ^bb13:  // pred: ^bb12
  ...
  ^bb14:  // 2 preds: ^bb12, ^bb13
    %_utf8_hal_executable_format_E03EECB63A2AAF52_17 = vm.const.ref.rodata @_utf8_hal_executable_format_E03EECB63A2AAF52 : !vm.buffer
    %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_18 = vm.const.ref.rodata @_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF : !vm.buffer
    %30:2 = vm.call @hal.device.query.i64(%18, %_utf8_hal_executable_format_E03EECB63A2AAF52_17, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_18) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
    %nz_19 = vm.cmp.nz.i64 %30#1 : i64
    %31 = vm.select.i32 %30#0, %nz_19, %zero : i32
    %32 = vm.select.i64 %31, %zero_4, %c-1 : i64
    %eq_20 = vm.cmp.eq.i64 %32, %zero_4 : i64
    vm.global.store.ref %18, @__device_1 : !vm.ref<!hal.device>
    vm.cond_br %eq_20, ^bb15, ^bb16
  ^bb15:  // pred: ^bb14
    %main_dispatch_0_embedded_elf_riscv_32 = vm.const.ref.rodata @main_dispatch_0_embedded_elf_riscv_32 : !vm.buffer
    %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_21 = vm.const.ref.rodata @_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF : !vm.buffer
    %ref_22 = vm.call @hal.executable.create(%18, %c-1, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_21, %main_dispatch_0_embedded_elf_riscv_32, %null) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
    vm.br ^bb17(%ref_22 : !vm.ref<!hal.executable>)
  ^bb16:  // pred: ^bb14
    ...
    vm.br ^bb17(%null_2 : !vm.ref<!hal.executable>)
  ^bb17(%33: !vm.ref<!hal.executable>):  // 2 preds: ^bb15, ^bb16
    %__device_1 = vm.global.load.ref immutable @__device_1 : !vm.ref<!hal.device>
    %ref_23 = vm.call @hal.device.allocator(%__device_1) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
    %ref_24 = vm.call @hal.allocator.import(%ref_23, %c1, %c-1, %c48, %c527363, %_const, %zero_4, %c8448) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
    ...
    vm.cond_br %rnz, ^bb19(%null_5, %ref_24 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb18
  ^bb18:  // pred: ^bb17
    %ref_25 = vm.call @hal.allocator.allocate(%ref_23, %c-1, %c48, %c527363, %c8448) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
    %ref_26 = vm.call @hal.ex.file.from_memory(%__device_1, %c-1, %c1, %_const, %zero_4, %c8448, %zero) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
    %ref_27 = vm.call @hal.fence.create(%__device_1, %zero_4) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
    vm.call @hal.device.queue.read(%__device_1, %c-1, %null_5, %ref_27, %ref_26, %zero_4, %ref_25, %zero_4, %c8448, %zero_4) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
    vm.br ^bb19(%ref_27, %ref_25 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb19(%34: !vm.ref<!hal.fence>, %35: !vm.ref<!hal.buffer>):  // 2 preds: ^bb17, ^bb18
    %36 = vm.call.variadic @hal.fence.await(%c-1_3, %zero_4, [%34]) : (i32, i64, !vm.ref<!hal.fence> ...) -> i32
