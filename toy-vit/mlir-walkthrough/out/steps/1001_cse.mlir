module attributes {llvm.data_layout = "e-m:e-p:32:32-i64:64-n32-S128", llvm.target_triple = "riscv32-unknown-unknown-eabi-elf"} {
  ...
  ^bb11:  // pred: ^bb7
    ...
    llvm.br ^bb5(%281, %280 : i32, !llvm.array<8 x vector<8xf32>>) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  ...
  ^bb25:  // pred: ^bb21
    ...
    %349 = llvm.fadd %332, %348 : vector<8xf32>
    %350 = llvm.fadd %334, %348 : vector<8xf32>
    %351 = llvm.fadd %336, %348 : vector<8xf32>
    %352 = llvm.fadd %338, %348 : vector<8xf32>
    %353 = llvm.fadd %340, %348 : vector<8xf32>
    %354 = llvm.fadd %342, %348 : vector<8xf32>
    %355 = llvm.fadd %344, %348 : vector<8xf32>
    %356 = llvm.fadd %346, %348 : vector<8xf32>
    %357 = llvm.fmul %349, %349 : vector<8xf32>
    %358 = llvm.fmul %350, %350 : vector<8xf32>
    %359 = llvm.fmul %351, %351 : vector<8xf32>
    %360 = llvm.fmul %352, %352 : vector<8xf32>
    %361 = llvm.fmul %353, %353 : vector<8xf32>
    %362 = llvm.fmul %354, %354 : vector<8xf32>
    %363 = llvm.fmul %355, %355 : vector<8xf32>
    %364 = llvm.fmul %356, %356 : vector<8xf32>
    %365 = llvm.fmul %357, %349 : vector<8xf32>
    %366 = llvm.fmul %358, %350 : vector<8xf32>
    %367 = llvm.fmul %359, %351 : vector<8xf32>
    %368 = llvm.fmul %360, %352 : vector<8xf32>
    %369 = llvm.fmul %361, %353 : vector<8xf32>
    %370 = llvm.fmul %362, %354 : vector<8xf32>
    %371 = llvm.fmul %363, %355 : vector<8xf32>
    %372 = llvm.fmul %364, %356 : vector<8xf32>
    %373 = llvm.extractvalue %55[0] : !llvm.array<8 x vector<8xf32>> 
    %374 = llvm.fmul %365, %373 : vector<8xf32>
    %375 = llvm.extractvalue %55[1] : !llvm.array<8 x vector<8xf32>> 
    %376 = llvm.fmul %366, %375 : vector<8xf32>
    %377 = llvm.extractvalue %55[2] : !llvm.array<8 x vector<8xf32>> 
    %378 = llvm.fmul %367, %377 : vector<8xf32>
    %379 = llvm.extractvalue %55[3] : !llvm.array<8 x vector<8xf32>> 
    %380 = llvm.fmul %368, %379 : vector<8xf32>
    %381 = llvm.extractvalue %55[4] : !llvm.array<8 x vector<8xf32>> 
    %382 = llvm.fmul %369, %381 : vector<8xf32>
    %383 = llvm.extractvalue %55[5] : !llvm.array<8 x vector<8xf32>> 
    %384 = llvm.fmul %370, %383 : vector<8xf32>
    %385 = llvm.extractvalue %55[6] : !llvm.array<8 x vector<8xf32>> 
    %386 = llvm.fmul %371, %385 : vector<8xf32>
    %387 = llvm.extractvalue %55[7] : !llvm.array<8 x vector<8xf32>> 
    %388 = llvm.fmul %372, %387 : vector<8xf32>
    %389 = llvm.fadd %349, %374 : vector<8xf32>
    %390 = llvm.fadd %350, %376 : vector<8xf32>
    %391 = llvm.fadd %351, %378 : vector<8xf32>
    %392 = llvm.fadd %352, %380 : vector<8xf32>
    %393 = llvm.fadd %353, %382 : vector<8xf32>
    %394 = llvm.fadd %354, %384 : vector<8xf32>
    %395 = llvm.fadd %355, %386 : vector<8xf32>
    %396 = llvm.fadd %356, %388 : vector<8xf32>
    %397 = llvm.extractvalue %56[0] : !llvm.array<8 x vector<8xf32>> 
    %398 = llvm.fmul %389, %397 : vector<8xf32>
    %399 = llvm.extractvalue %56[1] : !llvm.array<8 x vector<8xf32>> 
    %400 = llvm.fmul %390, %399 : vector<8xf32>
    %401 = llvm.extractvalue %56[2] : !llvm.array<8 x vector<8xf32>> 
    %402 = llvm.fmul %391, %401 : vector<8xf32>
    %403 = llvm.extractvalue %56[3] : !llvm.array<8 x vector<8xf32>> 
    %404 = llvm.fmul %392, %403 : vector<8xf32>
    %405 = llvm.extractvalue %56[4] : !llvm.array<8 x vector<8xf32>> 
    %406 = llvm.fmul %393, %405 : vector<8xf32>
    %407 = llvm.extractvalue %56[5] : !llvm.array<8 x vector<8xf32>> 
    %408 = llvm.fmul %394, %407 : vector<8xf32>
    %409 = llvm.extractvalue %56[6] : !llvm.array<8 x vector<8xf32>> 
    %410 = llvm.fmul %395, %409 : vector<8xf32>
    %411 = llvm.extractvalue %56[7] : !llvm.array<8 x vector<8xf32>> 
    %412 = llvm.fmul %396, %411 : vector<8xf32>
    ...
    %485 = llvm.fmul %453, %453 : vector<8xf32>
    %486 = llvm.fmul %454, %454 : vector<8xf32>
    %487 = llvm.fmul %455, %455 : vector<8xf32>
    %488 = llvm.fmul %456, %456 : vector<8xf32>
    %489 = llvm.fmul %457, %457 : vector<8xf32>
    %490 = llvm.fmul %458, %458 : vector<8xf32>
    %491 = llvm.fmul %459, %459 : vector<8xf32>
    %492 = llvm.fmul %460, %460 : vector<8xf32>
    ...
    %597 = llvm.fmul %453, %582 : vector<8xf32>
    %598 = llvm.fmul %454, %584 : vector<8xf32>
    %599 = llvm.fmul %455, %586 : vector<8xf32>
    %600 = llvm.fmul %456, %588 : vector<8xf32>
    %601 = llvm.fmul %457, %590 : vector<8xf32>
    %602 = llvm.fmul %458, %592 : vector<8xf32>
    %603 = llvm.fmul %459, %594 : vector<8xf32>
    %604 = llvm.fmul %460, %596 : vector<8xf32>
    ...
    %678 = llvm.fadd %669, %677 : vector<8xf32>
    %679 = llvm.extractvalue %57[1] : !llvm.array<8 x vector<8xf32>> 
    %680 = llvm.fadd %670, %679 : vector<8xf32>
    %681 = llvm.extractvalue %57[2] : !llvm.array<8 x vector<8xf32>> 
    %682 = llvm.fadd %671, %681 : vector<8xf32>
    %683 = llvm.extractvalue %57[3] : !llvm.array<8 x vector<8xf32>> 
    %684 = llvm.fadd %672, %683 : vector<8xf32>
    %685 = llvm.extractvalue %57[4] : !llvm.array<8 x vector<8xf32>> 
    %686 = llvm.fadd %673, %685 : vector<8xf32>
    %687 = llvm.extractvalue %57[5] : !llvm.array<8 x vector<8xf32>> 
    %688 = llvm.fadd %674, %687 : vector<8xf32>
    %689 = llvm.extractvalue %57[6] : !llvm.array<8 x vector<8xf32>> 
    %690 = llvm.fadd %675, %689 : vector<8xf32>
    %691 = llvm.extractvalue %57[7] : !llvm.array<8 x vector<8xf32>> 
    %692 = llvm.fadd %676, %691 : vector<8xf32>
    %693 = llvm.extractvalue %58[0] : !llvm.array<8 x vector<8xf32>> 
    %694 = llvm.fmul %349, %693 : vector<8xf32>
    %695 = llvm.extractvalue %58[1] : !llvm.array<8 x vector<8xf32>> 
    %696 = llvm.fmul %350, %695 : vector<8xf32>
    %697 = llvm.extractvalue %58[2] : !llvm.array<8 x vector<8xf32>> 
    %698 = llvm.fmul %351, %697 : vector<8xf32>
    %699 = llvm.extractvalue %58[3] : !llvm.array<8 x vector<8xf32>> 
    %700 = llvm.fmul %352, %699 : vector<8xf32>
    %701 = llvm.extractvalue %58[4] : !llvm.array<8 x vector<8xf32>> 
    %702 = llvm.fmul %353, %701 : vector<8xf32>
    %703 = llvm.extractvalue %58[5] : !llvm.array<8 x vector<8xf32>> 
    %704 = llvm.fmul %354, %703 : vector<8xf32>
    %705 = llvm.extractvalue %58[6] : !llvm.array<8 x vector<8xf32>> 
    %706 = llvm.fmul %355, %705 : vector<8xf32>
    %707 = llvm.extractvalue %58[7] : !llvm.array<8 x vector<8xf32>> 
    %708 = llvm.fmul %356, %707 : vector<8xf32>
    %709 = llvm.fmul %694, %678 : vector<8xf32>
    %710 = llvm.fmul %696, %680 : vector<8xf32>
    %711 = llvm.fmul %698, %682 : vector<8xf32>
    %712 = llvm.fmul %700, %684 : vector<8xf32>
    %713 = llvm.fmul %702, %686 : vector<8xf32>
    %714 = llvm.fmul %704, %688 : vector<8xf32>
    %715 = llvm.fmul %706, %690 : vector<8xf32>
    %716 = llvm.fmul %708, %692 : vector<8xf32>
    ...
    llvm.br ^bb3(%748 : i32) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  ^bb26:  // pred: ^bb3
    %749 = llvm.add %88, %54 : i32
    llvm.br ^bb1(%749 : i32) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
