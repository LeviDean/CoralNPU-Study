module {
  func.func @main_dispatch_0_matmul_17x64x32_f32() {
    ...
    scf.if %9 {
      ...
      %subview_15 = memref.subview %subview[0, 0] [%12, 64] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>> to memref<?x64xf32, strided<[64, 1], offset: ?>>
      scf.for %arg0 = %c0 to %12 step %c8 {
        ...
        scf.for %arg1 = %c0 to %c64 step %c8 {
          %subview_19 = memref.subview %subview_15[%arg0, %arg1] [%15, 8] [1, 1] : memref<?x64xf32, strided<[64, 1], offset: ?>> to memref<?x8xf32, strided<[64, 1], offset: ?>>
          ...
          %51 = scf.for %arg2 = %c0 to %c32 step %c1 iter_args(%arg3 = %50) -> (vector<8x8xf32>) {
            %subview_22 = memref.subview %assume_align[%25, %arg2] [%15, 1] [1, 1] : memref<17x32xf32> to memref<?x1xf32, strided<[32, 1], offset: ?>>
            %120 = arith.index_cast %15 : index to i32
            %121 = vector.broadcast %120 : i32 to vector<8xi32>
            %122 = arith.cmpi sgt, %121, %cst : vector<8xi32>
            %subview_23 = memref.subview %subview_22[0, 0] [%15, 1] [1, 1] : memref<?x1xf32, strided<[32, 1], offset: ?>> to memref<?xf32, affine_map<(d0)[s0] -> (d0 * 32 + s0)>>
            %123 = scf.for %arg4 = %c0 to %c8 step %c1 iter_args(%arg5 = %0) -> (vector<8xf32>) {
              ...
              %207 = scf.if %206 -> (vector<8xf32>) {
                %208 = memref.load %subview_23[%arg4] : memref<?xf32, affine_map<(d0)[s0] -> (d0 * 32 + s0)>>
          ...
          vector.maskedstore %subview_19[%c0, %c0], %105, %104 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %106 = vector.extract %103[1] : vector<8xf32> from vector<8x8xf32>
          %107 = vector.extract %16[1] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c1, %c0], %107, %106 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %108 = vector.extract %103[2] : vector<8xf32> from vector<8x8xf32>
          %109 = vector.extract %16[2] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c2, %c0], %109, %108 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %110 = vector.extract %103[3] : vector<8xf32> from vector<8x8xf32>
          %111 = vector.extract %16[3] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c3, %c0], %111, %110 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %112 = vector.extract %103[4] : vector<8xf32> from vector<8x8xf32>
          %113 = vector.extract %16[4] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c4, %c0], %113, %112 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %114 = vector.extract %103[5] : vector<8xf32> from vector<8x8xf32>
          %115 = vector.extract %16[5] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c5, %c0], %115, %114 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %116 = vector.extract %103[6] : vector<8xf32> from vector<8x8xf32>
          %117 = vector.extract %16[6] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c6, %c0], %117, %116 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
          %118 = vector.extract %103[7] : vector<8xf32> from vector<8x8xf32>
          %119 = vector.extract %16[7] : vector<8xi1> from vector<8x8xi1>
          vector.maskedstore %subview_19[%c7, %c0], %119, %118 : memref<?x8xf32, strided<[64, 1], offset: ?>>, vector<8xi1>, vector<8xf32>
        } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
      } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
    }
    return
