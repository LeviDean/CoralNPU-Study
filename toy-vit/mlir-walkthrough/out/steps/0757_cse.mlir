util.func public @main(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @main(%input0: tensor<17x32xf32>) -> (%output0: tensor<17x64xf32>)"}} {
  ...
  %2 = stream.cmd.execute on(#hal.device.affinity<@__device_1>) await(%1) => with(%0 as %arg1: !stream.resource<external>{%c2176}, %__hoisted_tensor_64xf32 as %arg2: !stream.resource<constant>{%c8448}, %__hoisted_tensor_64xf32 as %arg3: !stream.resource<constant>{%c8448}, %result as %arg4: !stream.resource<external>{%c4352}) {
