      ...
      scf.for %arg1 = %c0 to %c64 step %c8 {
        ...
        scf.for %arg2 = %c0 to %15 step %c1 {
          scf.for %arg3 = %c0 to %c8 step %c1 {
            %120 = memref.load %subview_12[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
            memref.store %120, %subview_14[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
          }
        }
        ...
        scf.for %arg2 = %c0 to %15 step %c1 {
          scf.for %arg3 = %c0 to %c8 step %c1 {
            %120 = memref.load %subview_12[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
            memref.store %120, %subview_15[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
          }
        }
        scf.for %arg2 = %c0 to %15 step %c1 {
          scf.for %arg3 = %c0 to %c8 step %c1 {
            %120 = memref.load %subview_14[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
            memref.store %120, %subview_15[%arg2, %arg3] : memref<?x8xf32, strided<[8, 1]>>
          }
        }
