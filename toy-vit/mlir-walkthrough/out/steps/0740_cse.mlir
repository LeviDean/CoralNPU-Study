util.func public @main(%arg0: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @main(%input0: tensor<17x32xf32>) -> (%output0: tensor<17x64xf32>)"}} {
  ...
  %1 = stream.timepoint.join max(%__hoisted_tensor_64xf32__timepoint, %__hoisted_tensor_64xf32__timepoint) => !stream.timepoint
  ...
  %2 = stream.timepoint.join max(%__hoisted_tensor_64xf32__timepoint, %__hoisted_tensor_64xf32__timepoint, %result_timepoint) => !stream.timepoint
  %3 = stream.cmd.execute on(#hal.device.affinity<@__device_1>) await(%2) => with(%0 as %arg1: !stream.resource<external>{%c2176}, %__constant_tensor_64x32xf32 as %arg2: !stream.resource<constant>{%__constant_tensor_64x32xf32__storage_size}, %__hoisted_tensor_64xf32 as %arg3: !stream.resource<constant>{%__hoisted_tensor_64xf32__storage_size}, %result as %arg4: !stream.resource<external>{%c4352}) {
