...
module attributes {stream.topology = #hal.device.topology<links = [(@__device_0 -> @__device_1 = {unified_memory = true, transparent_access = true}), (@__device_1 -> @__device_0 = {unified_memory = true, transparent_access = true})]>} {
  ...
  ^bb7:  // 2 preds: ^bb5, ^bb6
    ...
    cf.br ^bb8
  ^bb8:  // pred: ^bb7
    %c18_i32_2 = arith.constant 18 : i32
    %false_3 = arith.constant false
    %c0_4 = arith.constant 0 : index
    %c1_5 = arith.constant 1 : index
    %14 = util.null : !hal.device
    %device_count_6 = hal.devices.count : index
    cf.br ^bb9(%c0_4, %c0_4, %14 : index, index, !hal.device)
  ^bb9(%15: index, %16: index, %17: !hal.device):  // 2 preds: ^bb8, ^bb12
    %18 = util.cmp.eq %17, %14 : !hal.device
    %19 = arith.cmpi slt, %15, %device_count_6 : index
    %20 = arith.andi %18, %19 : i1
    cf.cond_br %20, ^bb10, ^bb13
  ^bb10:  // pred: ^bb9
    %device_n_7 = hal.devices.get %15 : !hal.device
    %ok_8, %value_9 = hal.device.query<%device_n_7 : !hal.device> key("hal.device.id" :: "coralnpu") : i1, i1 = false
    cf.cond_br %value_9, ^bb11, ^bb12(%false_3 : i1)
  ^bb11:  // pred: ^bb10
    %ok_10, %value_11 = hal.device.query<%device_n_7 : !hal.device> key("hal.executable.format" :: "embedded-elf-riscv_32") : i1, i1 = false
    cf.br ^bb12(%value_11 : i1)
  ^bb12(%21: i1):  // 2 preds: ^bb10, ^bb11
    %22 = arith.cmpi eq, %16, %c0_4 : index
    %23 = arith.select %21, %c1_5, %c0_4 : index
    %24 = arith.addi %16, %23 : index
    %25 = arith.andi %21, %22 : i1
    %26 = arith.select %25, %device_n_7, %14 : !hal.device
    %27 = arith.addi %15, %c1_5 : index
    cf.br ^bb9(%27, %24, %26 : index, index, !hal.device)
  ^bb13:  // pred: ^bb9
    cf.cond_br %18, ^bb14, ^bb15
  ^bb14:  // pred: ^bb13
    util.status.check_ok %c18_i32_2, "HAL device `__device_1` not found or unavailable: #hal.device.target<\22coralnpu\22, [#hal.executable.target<\22coralnpu\22, \22embedded-elf-riscv_32\22, {cpu = \22\22, cpu_features = \22+m,+f,+zvl128b,+zve32f,+zfbfmin,+zvfbfmin,+zvfbfwma\22, data_layout = \22e-m:e-p:32:32-i64:64-n32-S128\22, debug_symbols = false, iree.encoding.resolver = #iree_cpu.cpu_encoding_resolver<>, max_stack_allocation_size = 32768 : i64, native_vector_size = 32 : i64, target_abi = \22ilp32\22, target_triple = \22riscv32-unknown-unknown-eabi-elf\22}>]>"
    cf.br ^bb15
  ^bb15:  // 2 preds: ^bb13, ^bb14
    util.global.store %17, @__device_1 : !hal.device
    cf.br ^bb16
  ^bb16:  // pred: ^bb15
    %__device_1 = util.global.load @__device_1 : !hal.device
    %ok_12, %value_13 = hal.device.query<%__device_1 : !hal.device> key("hal.executable.format" :: "embedded-elf-riscv_32") : i1, i1 = false
    util.global.store %value_13, @__device_1_query_0_hal_executable_format_embedded_elf_riscv_32 : i1
    %c-1_i64 = arith.constant -1 : i64
    %c-1 = arith.constant -1 : index
    %c0_14 = arith.constant 0 : index
    %c14_i32 = arith.constant 14 : i32
    %28 = util.null : !hal.executable
    ...
    %29 = arith.select %__device_1_query_0_hal_executable_format_embedded_elf_riscv_32, %c0_14, %c-1 : index
    %30 = arith.cmpi eq, %29, %c0_14 : index
    cf.cond_br %30, ^bb17, ^bb18
  ^bb17:  // pred: ^bb16
    %executable = hal.executable.create device(%__device_1_15 : !hal.device) affinity(%c-1_i64) target(@main_dispatch_0::@embedded_elf_riscv_32) : !hal.executable
  ...
  ^bb20:  // pred: ^bb19
    ...
    %__device_1_18 = util.global.load immutable @__device_1 : !hal.device
    %allocator = hal.device.allocator<%__device_1_18 : !hal.device> : !hal.allocator
    %did_import, %mapped = hal.allocator.import<%allocator : !hal.allocator> source(%buffer_cst : !util.buffer)[%c0_17, %c8448] affinity(%c-1_i64_16) type(%memory_type) usage(%buffer_usage) : i1, !hal.buffer
    cf.cond_br %did_import, ^bb22(%32, %mapped : !hal.fence, !hal.buffer), ^bb21
  ^bb21:  // pred: ^bb20
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%c-1_i64_16) type(%memory_type) usage(%buffer_usage) : !hal.buffer{%c8448}
    %memory_file = hal.ex.file.from_memory device(%__device_1_18 : !hal.device) affinity(%c-1_i64_16) access(Read) buffer(%buffer_cst : !util.buffer)[%c0_17 for %c8448] flags(%c0_i32) : !hal.file
    %fence = hal.fence.create device(%__device_1_18 : !hal.device) flags("None") : !hal.fence
    hal.device.queue.read<%__device_1_18 : !hal.device> affinity(%c-1_i64_16) wait(%32) signal(%fence) source(%memory_file : !hal.file)[%c0_i64] target(%buffer : !hal.buffer)[%c0_17] length(%c8448) flags("None")
    cf.br ^bb22(%fence, %buffer : !hal.fence, !hal.buffer)
  ^bb22(%33: !hal.fence, %34: !hal.buffer):  // 2 preds: ^bb20, ^bb21
    %status = hal.fence.await until([%33]) timeout_millis(%c-1_i32) flags("None") : i32
    util.status.check_ok %status, "failed to wait on timepoint"
    util.global.store %34, @__hoisted_tensor_64xf32 : !hal.buffer
    cf.br ^bb23
  ^bb23:  // pred: ^bb22
    %35 = util.call @__main_memoize_apply() : () -> !hal.command_buffer
    util.global.store %35, @__main_memoize_result_0_device_1 : !hal.command_buffer
    util.return
  }
