vm.module public @module {
  ...
  vm.global.ref private mutable @__device_1 : !vm.ref<!hal.device>
  vm.global.ref private mutable @__device_1_executable_0_main_dispatch_0 : !vm.ref<!hal.executable>
  vm.global.ref private mutable @__hoisted_tensor_64xf32 : !vm.ref<!hal.buffer>
  vm.global.ref private mutable @__main_memoize_result_0_device_1 : !vm.ref<!hal.command_buffer>
  ...
  vm.func private @__main_memoize_apply() -> !vm.ref<!hal.command_buffer> attributes {inlining_policy = #util.inline.never, vm.unwind} {
    %c13 = vm.const.i32 13
    %c28 = vm.const.i32 28
    ...
    %c-1 = vm.const.i64 -1
    %__device_1 = vm.global.load.ref @__device_1 : !vm.ref<!hal.device>
    %__hoisted_tensor_64xf32 = vm.global.load.ref @__hoisted_tensor_64xf32 : !vm.ref<!hal.buffer>
    %__device_1_executable_0_main_dispatch_0 = vm.global.load.ref @__device_1_executable_0_main_dispatch_0 : !vm.ref<!hal.executable>
  ...
  vm.func private @main(%arg0: !vm.ref<!hal.buffer_view>) -> !vm.ref<!hal.buffer_view> attributes {iree.reflection = {iree.abi.declaration = "sync func @main(%input0: tensor<17x32xf32>) -> (%output0: tensor<17x64xf32>)"}, vm.unwind, vm.yield} {
    %c16 = vm.const.i32 16
    %c1 = vm.const.i32 1
    ...
    %c64 = vm.const.i64 64
    %__device_1 = vm.global.load.ref @__device_1 : !vm.ref<!hal.device>
    %__main_memoize_result_0_device_1 = vm.global.load.ref @__main_memoize_result_0_device_1 : !vm.ref<!hal.command_buffer>
  ...
  ^bb6:  // pred: ^bb5
    vm.discard.refs %null, %null_0, %null_4, %_const, %4 : !vm.buffer, !vm.ref<!hal.device>, !vm.ref<!hal.fence>, !vm.buffer, !vm.ref<!hal.device>
  ...
  ^bb9:  // pred: ^bb8
    vm.discard.refs %19 : !vm.ref<!hal.device>
  ...
  ^bb12:  // pred: ^bb8
    vm.discard.refs %null_0 : !vm.ref<!hal.device>
    vm.cond_br %20, ^bb13, ^bb14
  ^bb13:  // pred: ^bb12
    vm.discard.refs %null, %null_4, %_const, %19 : !vm.buffer, !vm.ref<!hal.fence>, !vm.buffer, !vm.ref<!hal.device>
  ...
  ^bb15:  // pred: ^bb14
    ...
    %ref_20 = vm.call @hal.executable.create(%19, %c-1, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_17, %main_dispatch_0_embedded_elf_riscv_32, %null) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
    %__device_1 = vm.global.load.ref @__device_1 : !vm.ref<!hal.device>
    %ref_21 = vm.call @hal.device.allocator(%__device_1) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
    %ref_22 = vm.call @hal.allocator.import(%ref_21, %c1, %c-1, %c48, %c527363, %_const, %zero_3, %c8448) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
    %rnz_23 = vm.cmp.nz.ref %ref_22 : !vm.ref<!hal.buffer>
    vm.global.store.ref %ref_20, @__device_1_executable_0_main_dispatch_0 : !vm.ref<!hal.executable>
    vm.cond_br %rnz_23, ^bb18(%null_4, %ref_22 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb17
  ^bb16:  // pred: ^bb14
    vm.discard.refs %null, %null_4, %_const, %19, %_utf8_embedded_elf_riscv_32_62D3CDC92A038ADF_17 : !vm.buffer, !vm.ref<!hal.fence>, !vm.buffer, !vm.ref<!hal.device>, !vm.buffer
  ...
  ^bb17:  // pred: ^bb15
    vm.discard.refs %ref_22 : !vm.ref<!hal.buffer>
    %ref_24 = vm.call @hal.allocator.allocate(%ref_21, %c-1, %c48, %c527363, %c8448) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
    %ref_25 = vm.call @hal.ex.file.from_memory(%__device_1, %c-1, %c1, %_const, %zero_3, %c8448, %zero) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
    %ref_26 = vm.call @hal.fence.create(%__device_1, %zero_3) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
    vm.call @hal.device.queue.read(%__device_1, %c-1, %null_4, %ref_26, %ref_25, %zero_3, %ref_24, %zero_3, %c8448, %zero_3) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
    vm.br ^bb19(%ref_26, %ref_24 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb18(%35: !vm.ref<!hal.fence>, %36: !vm.ref<!hal.buffer>):  // pred: ^bb15
    vm.discard.refs %_const, %__device_1, %ref_21 : !vm.buffer, !vm.ref<!hal.device>, !vm.ref<!hal.allocator>
    vm.br ^bb19(%35, %36 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb19(%37: !vm.ref<!hal.fence>, %38: !vm.ref<!hal.buffer>):  // 2 preds: ^bb17, ^bb18
    vm.call.variadic.yieldable @hal.fence.await(%c-1_2, %zero_3, %37) {segment_sizes = dense<[-1, -1, 1]> : vector<3xi16>, segment_types = [i32, i64, !vm.ref<!hal.fence>]} : (i32, i64, !vm.ref<!hal.fence>) -> ^bb20 (i32)
  ^bb20(%39: i32):  // pred: ^bb19
    vm.cond_br %39, ^bb22, ^bb21
  ^bb21:  // pred: ^bb20
    vm.global.store.ref %38, @__hoisted_tensor_64xf32 : !vm.ref<!hal.buffer>
    %ref_27 = vm.call @__main_memoize_apply() : () -> !vm.ref<!hal.command_buffer>
    vm.global.store.ref %ref_27, @__main_memoize_result_0_device_1 : !vm.ref<!hal.command_buffer>
    vm.return
  ^bb22:  // pred: ^bb20
    vm.discard.refs %38 : !vm.ref<!hal.buffer>
    vm.fail %39, "failed to wait on timepoint"
  }
}
