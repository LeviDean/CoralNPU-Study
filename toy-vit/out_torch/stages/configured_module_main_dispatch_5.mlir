    ...
    builtin.module {
      func.func @main_dispatch_5_matmul_17x96x32_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert>} {
        ...
        %4:2 = util.assume.int 
            ...
            %3[<umin = 57472, umax = 57472, udiv = 57472>, <umin = 24704, umax = 24704, udiv = 24704>]
          : index, index
        ...
        %6 = hal.interface.binding.subspan layout(<constants = 2, bindings = [#hal.pipeline.binding<storage_buffer, "ReadOnly|Indirect">, #hal.pipeline.binding<storage_buffer, ReadOnly>, #hal.pipeline.binding<storage_buffer, Indirect>], flags = Indirect>) binding(1) alignment(64) offset(%4#1) flags(ReadOnly) : !iree_tensor_ext.dispatch.tensor<readonly:tensor<96x32xf32>>
        ...
        %9 = iree_tensor_ext.dispatch.tensor.load %6, offsets = [0, 0], sizes = [96, 32], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<96x32xf32>> -> tensor<96x32xf32>
