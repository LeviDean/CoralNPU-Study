...
.Lfunc_begin0:
	.file	1 "/home/builder/work/vit-torch/stages/exe" "configured_module_main_dispatch_5.mlir"
	.loc	1 1 0
...
.LBB0_8:
	...
	vse32.v	v30, (ra), v0.t
	vmv1r.v	v0, v11
	vse32.v	v28, (s11), v0.t
	vmv1r.v	v0, v12
	vse32.v	v26, (s10), v0.t
	vmv1r.v	v0, v19
	vse32.v	v24, (s9), v0.t
	vmv1r.v	v0, v16
	vse32.v	v22, (s8), v0.t
...
.LBB0_13:
	...
	vfmv.s.f	v18, fa5
	addi	t4, t1, 1
	vsetvli	zero, t4, e32, m2, tu, ma
	vslideup.vx	v2, v18, t1
	j	.LBB0_12
.LBB0_15:
	.loc	1 28 8
	li	a0, 0
...
.Linfo_string0:
	.asciz	"IREE"
.Linfo_string1:
	.asciz	"configured_module_main_dispatch_5.mlir"
.Linfo_string2:
	.asciz	"/home/builder/work/vit-torch/stages/exe"
.Linfo_string3:
