util.func private @__main_memoize_apply_23() -> !hal.command_buffer attributes {inlining_policy = #util.inline.never} {
  ...
  %cmd = hal.command_buffer.create device(%__device_1 : !hal.device) mode("None") categories("Transfer|Dispatch") affinity(%c-1_i64) bindings(%c3) : !hal.command_buffer
